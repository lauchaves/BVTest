...
gulp.task('styles', function() {
  return gulp.src('app/js/styles/main.less')
    .pipe($.plumber())
    .pipe($.less())
...
gulp.task('fonts', function() {
  return gulp.src(require('main-bower-files')().concat('app/js/styles/fonts/**/*')
...
gulp.task('wiredep', function() {
  ...
  gulp.src('app/js/styles/*.less')
    .pipe(wiredep())
    .pipe(gulp.dest('app/js/styles'));
...
gulp.task('watch', ['connect'], function() {
  ...
  gulp.watch('app/js/styles/**/*.less', ['styles']);
...
gulp.task('docs', [], function() {
  return gulp.src('app/controllers/**/**')
    .pipe($.ngdocs.process())
    .pipe(gulp.dest('./docs'));
});
